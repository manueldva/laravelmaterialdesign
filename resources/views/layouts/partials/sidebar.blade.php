<section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    @if(Auth::user()->file)
                        <img src="{{ asset(Auth::user()->file) }}" width="48" height="48" alt="User" />
                    @else
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li role="seperator" class="divider"></li>
                            <li>
                                <a href="javascript:void(0);" href="{{ route('logout') }}"  onclick="event.preventDefault();
            ...
            <div class="menu">
                <ul class="list">
                    <li class="header">NAVEGACIÓN PRINCIPAL
                    </li>
                    ...
                    <li {{Route::is('manageusers.index')? 'class=active':''}}>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 <a href="javascript:void(0);">Admin - CMS</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
